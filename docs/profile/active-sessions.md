...
Untuk setiap sesi aktif, anda akan melihat maklumat seperti:
- **Device** (jenis peranti, contohnya Desktop)
- **IP Address**
- **Browser / OS**
- **Logged in** (tarikh dan masa log masuk)
- **Last active** (aktif terakhir)
- **Remember Me** (status simpan log masuk)
