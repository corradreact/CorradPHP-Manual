...
export default defineConfig({
  ...
  description: 'Manual Pengguna untuk Sistem Corrad PHP84',
  cleanUrls: true,
  ...
  locales: {
    '/': {
      ...
      themeConfig: {
        ...
        footer: {
          message: 'Manual Pengguna Corrad PHP84',
        ...
        sidebar: [
          {
            ...
            collapsed: false,
            items: [
              { text: 'Import Export v2', link: '/en/data-monitoring/import-export-v2' },
              { text: 'Audit Trail', link: '/en/data-monitoring/audit-trail' },
              { text: 'Application Logs', link: '/en/data-monitoring/application-logs' },
              { text: 'Log Access', link: '/en/data-monitoring/log-access' },
              { text: 'Job Queue', link: '/en/data-monitoring/job-queue' },
              { text: 'Structured Logs', link: '/en/data-monitoring/structured-logs' },
              { text: 'Test Results', link: '/en/data-monitoring/test-results' }
            ]
          }
        ],
        outline: {
