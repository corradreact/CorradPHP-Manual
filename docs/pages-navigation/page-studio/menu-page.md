...
::: tip Langkah 2
6. Pilih Parent Menu yang sesuai.
- Pilih **Root (Top Level)** jika menu tersebut ingin dijadikan menu utama.
- Pilih menu sedia ada jika menu baharu tersebut ingin diletakkan di bawah menu tertentu.
![Isi Maklumat New Menu](/image/pagestudio/fill-new-menu.png)

7. Semak semula maklumat yang telah dimasukkan.
8. Klik button **Create Menu** untuk menyimpan menu baharu.

:::
::: tip Langkah 3

9. Setelah menu berjaya dicipta, menu tersebut akan dipaparkan dalam senarai menu di panel kiri.
...
- Jika Parent Menu ditetapkan kepada Root (Top Level), menu akan muncul sebagai menu utama. 
